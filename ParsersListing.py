...
#url = "http://www.goldendragonindia.com/"

flow_control_pool = ThreadPool(processes=2)
flow_control_pool.apply_async(PushData, (url,url,))
flow_control_pool.apply_async(FetchUrls.MongoUpdateToSql, (url,))
"""
#PushData(url,url)
